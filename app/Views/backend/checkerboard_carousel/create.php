        ...
        <div class="card shadow">
          <div class="card-header border-0">
            <div class="row align-items-center">
              <div class="col">
                <h3 class="mb-0">Tambah Layanan Checkerboard Carousel</h3>
              </div>
          ...
          <div class="card-body">
            ...
            <form action="<?= base_url('checkerboard-carousel/store') ?>" method="post" enctype="multipart/form-data">
              <?= csrf_field() ?>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" id="ikon" name="ikon" value="<?= old('ikon') ?>" placeholder="fas fa-heartbeat" required>
              ...
              <div class="form-group">
                ...
                <div class="text-center p-3 border rounded">
                  <i id="preview-icon" class="fas fa-heartbeat fa-3x text-primary"></i>
                  <p class="mt-2 mb-0" id="preview-text">Nama Layanan</p>
                </div>
              </div>
