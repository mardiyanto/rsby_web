    ...
    <div class="row">
      <div class="col-xl-12">
        <div class="card shadow">
          ...
          <div class="card-body">
            <form method="POST" action="<?= base_url('faq/edit/' . $faq['id']) ?>" id="faqForm">
              <?= csrf_field() ?>
              ...
              <div class="form-group">
                ...
                <textarea class="form-control <?= session()->getFlashdata('errors.pertanyaan') ? 'is-invalid' : '' ?>" 
                          ...
                          placeholder="Masukkan pertanyaan FAQ..." required><?= old('pertanyaan', $faq['pertanyaan']) ?></textarea>
              ...
              <div class="form-group">
                ...
                <textarea class="form-control <?= session()->getFlashdata('errors.jawaban') ? 'is-invalid' : '' ?>" 
                          ...
                          placeholder="Masukkan jawaban FAQ..." required><?= old('jawaban', $faq['jawaban']) ?></textarea>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control <?= session()->getFlashdata('errors.urutan') ? 'is-invalid' : '' ?>" 
                           id="urutan" name="urutan" value="<?= old('urutan', $faq['urutan']) ?>" min="1" required>
...
$(document).ready(function() {
  ...
  $('#faqForm').submit(function(e) {
    ...
    Swal.fire({
      title: 'Konfirmasi',
      text: 'Yakin ingin memperbarui FAQ ini?',
      icon: 'question',
