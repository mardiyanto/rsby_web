      ...
      <div class="col-xl-12">
        <div class="card shadow">
          <div class="card-header border-0">
            <h3 class="mb-0">Edit Kategori Download</h3>
          </div>
          <div class="card-body">
            ...
            <form action="<?= base_url('kategori-download/update/' . $kategori['id_kategori_download']) ?>" method="post" id="formKategori">
              <?= csrf_field() ?>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control <?= (session()->getFlashdata('errors.nama_kategori_download')) ? 'is-invalid' : '' ?>" 
                       ...
                       value="<?= old('nama_kategori_download', $kategori['nama_kategori_download']) ?>" 
                ...
                <?php endif; ?>
                <small class="form-text text-muted">Minimal 3 karakter, maksimal 100 karakter. Hanya huruf, angka, spasi, tanda hubung, dan underscore.</small>
              </div>
