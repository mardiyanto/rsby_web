      ...
      <div class="col-xl-12">
        <div class="card shadow">
          ...
          <div class="card-body">
            ...
            <?php endif; ?>
            <form method="post" action="<?= base_url('user/store') ?>" id="form-user">
              <?= csrf_field() ?>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Username <span class="text-danger">*</span></label>
                    <input type="text" name="username" class="form-control" value="<?= old('username') ?>" required maxlength="50" placeholder="Masukkan username">
                    <small class="form-text text-muted">Username harus unik dan tidak boleh mengandung spasi</small>
                  </div>
                  <div class="form-group">
                    <label>Nama Lengkap <span class="text-danger">*</span></label>
                    <input type="text" name="nama" class="form-control" value="<?= old('nama') ?>" required maxlength="100" placeholder="Masukkan nama lengkap">
                  </div>
                  <div class="form-group">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input type="password" name="password_confirm" id="password_confirm" class="form-control" required minlength="6" placeholder="Konfirmasi password">
                      <div class="input-group-append">
              ...
              <div id="progress-container" style="display:none;">
                ...
                <small class="text-muted">Menyimpan user...</small>
              </div>
...
$(function(){
    ...
    $('#form-user').on('submit', function(e){
        ...
        if(!username || !nama || !role || !password || !passwordConfirm){
            e.preventDefault();
            Swal.fire({
                icon: 'error',
                title: 'Error',
